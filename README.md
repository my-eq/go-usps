...
A lightweight, production-grade Go client library for the USPS Addresses 3.0 REST API.
...
- **🎯 Complete Coverage**: Implements all three USPS Addresses 3.0 API endpoints
- **💪 Strongly Typed**: All request and response types are fully typed based on the OpenAPI specification
- **🔒 OAuth Support**: Built-in OAuth token authentication with customizable token providers
- **🧪 Testable**: Designed with dependency injection for easy testing
- **📦 Lightweight**: Minimal external dependencies, uses Go standard library
...
- Go 1.19 or later
- USPS OAuth token (obtain from [USPS Developer Portal](https://developers.usps.com))

## API Documentation

For complete API documentation, see the [USPS Addresses API Documentation](https://developers.usps.com/addressesv3).
